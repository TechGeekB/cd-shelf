VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptAllTitlesNoContents 
   Bindings        =   "rptAllTitlesNoContents.dsx":0000
   Caption         =   "SHAILCdShelf"
   ClientHeight    =   6300
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8640
   Icon            =   "rptAllTitlesNoContents.dsx":001F
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   4605
         Object.Height          =   2160
         Picture         =   "rptAllTitlesNoContents.dsx":0329
      EndProperty
      ItemType1       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptAllTitlesNoContents"
